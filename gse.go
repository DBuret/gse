...
func main() {
	...
	if os.ExpandEnv("${GSE_BASEPATH}") != "" {
		gseBasePath = os.ExpandEnv("${GSE_BASEPATH}")
	}

	if os.ExpandEnv("${GSE_PORT}") != "" {
		gsePort = os.ExpandEnv("${GSE_PORT}")
	}

	http.HandleFunc(gseBasePath, handler)
